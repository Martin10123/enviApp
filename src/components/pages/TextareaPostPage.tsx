          ...
          <div className="w-full border border-gray-200 rounded-lg bg-gray-50">
            <div className="px-4 py-2 bg-white rounded-t-lg">
              ...
              <textarea
                id="comment"
                rows={6}
                className="w-full px-0 text-sm text-gray-900 bg-white border-0 focus:ring-0 outline-none"
            ...
            <div className="flex items-center justify-between px-3 py-2 border-t">
              ...
              <div className="flex ps-0 space-x-1 rtl:space-x-reverse sm:ps-2">
                <button
                  type="button"
                  className="inline-flex justify-center items-center p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-200"
                >
                  <svg
                    className="w-4 h-4"
                    aria-hidden="true"
